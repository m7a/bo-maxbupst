...
static void load_key_words(const uint8_t key[BLAKE3_KEY_LEN],
...
static void store_cv_words(uint8_t bytes_out[32], uint32_t cv_words[8]) {
...
static void hash_one_portable(const uint8_t *input, size_t blocks,
...
// https://codereview.qt-project.org/c/qt/qtbase/+/309265/1/src/corelib/tools/qcryptographichash.cpp#178
